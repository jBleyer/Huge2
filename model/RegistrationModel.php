...
class RegistrationModel
{
    ...
    public static function registerNewUser()
    {
        ...
        // Ich habe $user_activation_hash aus den parametern ganz am ende entfenrt und null eingesetzt
        if (!self::writeNewUserToDatabase($user_name, $user_password_hash, $user_email, time(), 'nuh')) {
        ...
        /*if (self::sendVerificationEmail($user_id, $user_email, null)) {
    ...
    /*
     * I have removed $captcha parameter in the registrationInputValidation function (it was before $user_name)
     */
     ...
     */
    //I have removed $user_activation_verification_code in function params + query->execute(array())
