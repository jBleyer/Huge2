<div class="container">
    ...
    <div class="login-box" style="width: 50%; display: block;">
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action">
            ...
            <input type="text" name="user_email_repeat" placeholder="repeat email address (to prevent typos)"
                required />
            ...
            <!-- I am the capture now -->
            <div class="g-recaptcha" data-sitekey="6Lcr61MsAAAAACWHUX5SNJFs0s8UbszZlZYLEsL6"></div>
...
<div class="container">
    ...
    <p style="display: block; font-size: 11px; color: #999;">I have removed the captcha function in register/index.php
    </p>
</div>